  ...
  return (
    <>
      ...
      <section className="s2-static-section">
        <h2>1. Who We Are</h2>
        <p>
          This Privacy Policy is issued by <strong>Joker Perfumes</strong>, operating the brand <strong>Joker Perfumes</strong>, with its registered office at Saudi Arabia ("Joker Perfumes", "we", "us"). It explains how we collect and handle personal information when you visit our website or place an order with us.
        </p>
      </section>
      ...
      <section className="s2-static-section">
        ...
        <ul>
          ...
          <li><strong>Payment data:</strong> Processed by our payment gateway partners. We do not see or store your full card details.</li>
      ...
      <section className="s2-static-section">
        ...
        <ul>
          ...
          <li>To comply with applicable Saudi Arabia laws and respond to lawful requests.</li>
        </ul>
      </section>
      ...
      <section className="s2-static-section">
        ...
        <ul>
          ...
          <li><strong>Legal authorities:</strong> When required by Saudi Arabia law, court order, or to protect our rights.</li>
        </ul>
      </section>
      ...
      <section className="s2-static-section">
        ...
        <p>
          We retain your personal data only for as long as needed to provide our services, comply with tax and accounting obligations under Saudi Arabia law, and resolve disputes. You may request deletion of your account and associated data at any time by emailing us at <a href="mailto:info@jokerperfumes.com">info@jokerperfumes.com</a>.
        </p>
      </section>
      ...
      <section className="s2-static-section">
        <h2>7. Your Rights</h2>
        <p>
          Subject to Saudi Arabia law (including the applicable data protection law), you have the right to access, correct, or delete the personal data we hold about you, and to withdraw consent at any time. To exercise these rights, write to <a href="mailto:info@jokerperfumes.com">info@jokerperfumes.com</a>.
        </p>
      </section>
      ...
      <section className="s2-static-section">
        ...
        <p>
          ...
          Saudi Arabia<br />
          Email: <a href="mailto:info@jokerperfumes.com">info@jokerperfumes.com</a><br />
          Phone / WhatsApp: <a href="tel:+966500000000">+966 50 000 0000</a>
        </p>
        <p>We will acknowledge complaints within 24 hours and aim to resolve them within 15 days, in line with applicable Saudi Arabia regulations.</p>
      </section>
    </>
  );
}
  ...
  return (
    <>
      ...
      <section className="s2-static-section">
        <h2>1. من نحن</h2>
        <p>
          صادرة هذه السياسة عن <strong>Joker Perfumes</strong>، المالكة لعلامة <strong>Joker Perfumes</strong>، ومقرّها المسجَّل في المملكة العربية السعودية ("Joker Perfumes"، "نحن"، "لدينا"). توضّح هذه السياسة كيف نقوم بجمع ومعالجة المعلومات الشخصية عند زيارتك لموقعنا الإلكتروني أو إجراء طلب لدينا.
        </p>
      </section>
      ...
      <section className="s2-static-section">
        ...
        <ul>
          ...
          <li><strong>بيانات الدفع:</strong> تُعالَج عن طريق شركاء بوابات الدفع لدينا. لا نطّلع على بيانات بطاقتك الكاملة ولا نخزّنها.</li>
      ...
      <section className="s2-static-section">
        ...
        <ul>
          ...
          <li>للامتثال للقوانين السعودية المعمول بها والاستجابة للطلبات القانونية.</li>
        </ul>
      </section>
      ...
      <section className="s2-static-section">
        ...
        <ul>
          ...
          <li><strong>الجهات القانونية:</strong> عند الاقتضاء بموجب القانون السعودي أو أمر قضائي أو لحماية حقوقنا.</li>
        </ul>
      </section>
      ...
      <section className="s2-static-section">
        ...
        <p>
          نحتفظ ببياناتك الشخصية فقط طوال الفترة اللازمة لتقديم خدماتنا، والامتثال للالتزامات الضريبية والمحاسبية بموجب القانون السعودي، ولحل النزاعات. يمكنك طلب حذف حسابك والبيانات المرتبطة به في أي وقت بمراسلتنا على <a href="mailto:info@jokerperfumes.com">info@jokerperfumes.com</a>.
        </p>
      </section>
      ...
      <section className="s2-static-section">
        <h2>7. حقوقك</h2>
        <p>
          مع مراعاة القانون السعودي (بما في ذلك قانون حماية البيانات المعمول به متى انطبق)، يحقّ لك الوصول إلى بياناتك الشخصية لدينا أو تصحيحها أو حذفها، وسحب موافقتك في أي وقت. لممارسة هذه الحقوق، يرجى المراسلة على <a href="mailto:info@jokerperfumes.com">info@jokerperfumes.com</a>.
        </p>
      </section>
      ...
      <section className="s2-static-section">
        ...
        <p>
          ...
          البريد الإلكتروني: <a href="mailto:info@jokerperfumes.com">info@jokerperfumes.com</a><br />
          الهاتف / واتساب: <a href="tel:+966500000000">+966 50 000 0000</a>
        </p>
        <p>سنُقرّ باستلام الشكاوى خلال 24 ساعة ونسعى إلى حلّها خلال 15 يومًا، وفقًا للأنظمة السعودية المعمول بها.</p>
      </section>
    </>
  );
}
...
export default function PrivacyPolicy() {
  ...
  return (
    <StaticPage
      ...
      description="Privacy Policy for Joker Perfumes. How we collect, use, and protect your personal information."
      descriptionAr="سياسة الخصوصية لـ Joker Perfumes. كيف نقوم بجمع معلوماتك الشخصية واستخدامها وحمايتها."
      regionNote
    >
